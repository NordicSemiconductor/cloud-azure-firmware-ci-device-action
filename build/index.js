...
const abortOn = multilineOrUndefined((0,core.getInput)('abort on'));
const endOn = multilineOrUndefined((0,core.getInput)('end on'));
const endOnWaitSeconds = parseInt((0,core.getInput)('end on waitSeconds'), 10);
